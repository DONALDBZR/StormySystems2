    ...
    public function register() {
        ...
        if (empty($this->API->resultSet())) {
            ...
            if ($age >= 13) {
                ...
                header("refresh:3.87; url = " . $this->domain . "/StormySystems2/Login", true, 302);
            } else {
                // Message to be encoded and sent
                $message = array(
                    "success" => "failure",
                ...
                header("refresh:3.87; url = " . $this->domain . "/StormySystems2", true, 302);
            }
        } else {
            // Message to be encoded and sent
            $message = array(
    ...
    public function checkLoginSession() {
        ...
        if ($_SESSION["username"] == $this->getUsername()) {
            ...
            if ($this->getType() == 0) {
                ...
                $this->Mail->Password = "Aegis4869_050200";
